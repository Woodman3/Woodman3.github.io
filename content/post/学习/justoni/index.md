...
唱名用来描述相对音高，音名用来描述绝对音高，我们最为熟知的唱名就是Do Re Mi。虽然在后文讨论的都是相对音高，但是唱名只有七个，而我将要推十二个音程关系，所以我还是用音名来研究。
...
和Do Re Mi一样，五音的音高是相对的而不是固定的，律名的音高则是固定的，所以不只有黄钟宫，还有太簇宫、姑洗宫，类似转调的操作。

黄钟是一根标准管，但是黄钟的频率也不是固定的，各个朝代都会重新规定标准的黄钟来彰显正统。
...
在五度相生律之后，人们发明了纯律。不再是一个一个的推出来，而是直接选择了整数比来规定各个音程关系。纯律在2和3这两个素数的基础上又增加了5。但是有三个素数的情况下就不能像五度相生那样一点一点的推出来了，也别太在乎这些频率比到底是怎么来的，问就是好听规定的（其实我也没找到相关资料）。

| 音名 | 音程关系             | 频率比   | 小数近似 | 备注             |
| ------ | -------------------- | --------- | -------- | ------------------ |
| C  | 一度 (Unison)          | $1:1$     | 1.000    | 基准音                |
| D  | 大二度 (Major Second)   | $9:8$     | 1.125    | 大全音 (Greater Tone) |
| E  | 大三度 (Major Third)    | $5:4$ | 1.250    | 纯律的核心特征        |
| F  | 纯四度 (Perfect Fourth) | $4:3$     | 1.333    | 纯正的四度              |
| G  | 纯五度 (Perfect Fifth)  | $3:2$     | 1.500    | 纯正的五度              |
| A  | 大六度 (Major Sixth)    | $5:3$     | 1.666    | 协和音程               |
| B  | 大七度 (Major Seventh)  | $15:8$    | 1.875    | 导音                 |
| C' | 八度 (Octave)          | $2:1$     | 2.000    | 频率翻倍               |

这些以频率比为基础的律制都有一个坏处：难以转调，一旦基音变了其他全都得变，为了克服这一点，后世的人们发明了平均律，如果有空的话我会另外写一篇博客说明。